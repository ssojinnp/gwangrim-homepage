...
export function Header() {
  return (
    <header className="sticky top-0 z-20 border-b border-line/80 bg-white/95 backdrop-blur-md">
      <div className="mx-auto flex w-[min(1120px,calc(100%-28px))] flex-col gap-3 py-3 md:w-[min(1120px,calc(100%-40px))] lg:min-h-[84px] lg:flex-row lg:items-center lg:justify-between lg:gap-6 lg:py-0">
        <div className="flex min-w-0 items-center justify-between gap-3">
          <a className="inline-flex min-w-0 items-center" href="#top" aria-label="광림전산 홈">
            <LogoMark size="md" className="max-w-[180px] md:max-w-[210px]" />
          </a>
