  ...
  return (
    <section id="top" className="border-b border-line bg-[#f7f9fc]">
      <div className="mx-auto w-[min(1180px,calc(100%-28px))] md:w-[min(1180px,calc(100%-40px))]">
        <div className="grid gap-4 py-8 md:py-12 lg:grid-cols-[minmax(0,1.04fr)_420px] lg:py-16 xl:grid-cols-[minmax(0,1.06fr)_450px]">
          ...
          <aside className="border border-line bg-brand-900 text-white">
